...
if __name__ == '__main__':
    ...
    users = []
    query = dict(selector = {"city": "Melbourne"}, fields = ["_id", "city"], limit = 10)
    response = couch.get(path = 'userdb/_find', body = query) # get users list of dict
    json_data = response.json() # load response as json
    print(json_data)
